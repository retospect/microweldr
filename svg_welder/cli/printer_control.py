...
Monitoring Modes:
  ...
  pipetting   - Microfluidic device with pipetting stops
    ...
    status_parser.add_argument('--json', action='store_true', help='Output raw JSON response')
    
    # Monitor command
    monitor_parser = subparsers.add_parser('monitor', help='Monitor print progress')
    monitor_parser.add_argument('--mode', choices=['standard', 'layed-back', 'pipetting'], 
                               default='standard', help='Monitoring mode (default: standard)')
    monitor_parser.add_argument('--interval', '-i', type=int, default=30, 
                               help='Check interval in seconds (default: 30)')
    monitor_parser.add_argument('--verbose', '-v', action='store_true', help='Show detailed output')
    ...
    stop_parser.add_argument('--verbose', '-v', action='store_true', help='Show detailed output')
    
    # Test command
    test_parser = subparsers.add_parser('test', help='Test PrusaLink connection')
    test_parser.add_argument('--verbose', '-v', action='store_true', help='Show detailed test results')
