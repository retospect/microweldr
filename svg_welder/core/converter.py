...
class SVGToGCodeConverter:
    ...
    def generate_gcode(self, output_path: str | Path, skip_bed_leveling: bool = False) -> None:
    ...
    def convert(self, svg_path: str | Path, gcode_path: str | Path, 
                skip_bed_leveling: bool = False) -> List[WeldPath]:
