...
class PrusaLinkClient:
    ...
    def _load_config(self, config_path: Optional[str] = None) -> Dict[str, Any]:
        ...
        if 'password' not in prusalink_config and 'api_key' not in prusalink_config:
            raise PrusaLinkConfigError("Missing required field: either 'password' (LCD password) or 'api_key'")
    ...
    def get_printer_info(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if response.status_code == 401:
                ...
                raise PrusaLinkConnectionError(f"Failed to get printer info: {response.status_code}")
    ...
    def get_storage_info(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if response.status_code == 401:
                ...
                raise PrusaLinkConnectionError(f"Failed to get storage info: {response.status_code}")
    ...
    def get_printer_status(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if response.status_code == 401:
                ...
                raise PrusaLinkConnectionError(f"Failed to get printer status: {response.status_code}")
    ...
    def get_job_status(self) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            if response.status_code == 204:
                ...
                raise PrusaLinkConnectionError(f"Failed to get job status: {response.status_code}")
