...
"""
    ...
    def test_custom_weld_parameters(self, generator):
        ...
        points = [
            WeldPoint(10, 10, "normal", custom_temp=160.0, custom_weld_time=0.5, custom_weld_height=0.030),
            WeldPoint(20, 10, "normal", custom_temp=170.0, custom_weld_time=0.2, custom_weld_height=0.025),
        ]
    ...
    def test_stop_weld_type(self, generator):
        ...
        weld_paths = [WeldPath(points, "stop", "stop_test", pause_message="Insert component")]
    ...
    def test_pipette_weld_type(self, generator):
        ...
        weld_paths = [WeldPath(points, "pipette", "pipette_test", pause_message="Fill with reagent")]
    ...
    def test_mixed_weld_types(self, generator):
        ...
        with tempfile.NamedTemporaryFile(mode="w", suffix=".gcode", delete=False) as f:
            ...
            assert "M104 S130" in gcode_content or "M109 S130" in gcode_content  # Normal weld temp
            assert "M104 S180" in gcode_content or "M109 S180" in gcode_content  # Light weld temp
    ...
    def test_bed_leveling_skip(self, generator):
        ...
        with tempfile.NamedTemporaryFile(mode="w", suffix=".gcode", delete=False) as f:
            ...
            assert "Bed leveling disabled" in gcode_content or "skip" in gcode_content.lower()
    ...
    def test_point_overrides_path_parameters(self, generator):
        ...
        with tempfile.NamedTemporaryFile(mode="w", suffix=".gcode", delete=False) as f:
            ...
            assert "M104 S165" in gcode_content or "M109 S165" in gcode_content  # Point override
            assert "M104 S150" in gcode_content or "M109 S150" in gcode_content  # Path level
