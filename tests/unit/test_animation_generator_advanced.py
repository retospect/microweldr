...
"""
    ...
    def test_pipette_weld_animation(self, generator):
        ...
        weld_paths = [WeldPath(points, "pipette", "pipette_test", pause_message="Fill reagent")]
        ...
        with tempfile.NamedTemporaryFile(mode="w", suffix=".svg", delete=False) as f:
            ...
            assert "pause" in animation_content.lower() or "Fill reagent" in animation_content
    ...
    def test_animation_with_custom_timing(self, config_content):
        ...
        modified_config = config_content.replace(
            ...
            "pause_time = 2.0", "pause_time = 1.0"
        ).replace(
            "min_animation_duration = 10.0", "min_animation_duration = 5.0"
        )
    ...
    def test_animation_viewport_calculation(self, generator):
        ...
        with tempfile.NamedTemporaryFile(mode="w", suffix=".svg", delete=False) as f:
            ...
            assert "cx=\"5" in animation_content or "cx=\"15" in animation_content  # Accounting for padding
    ...
    def test_animation_with_custom_colors(self, generator):
        ...
        with tempfile.NamedTemporaryFile(mode="w", suffix=".svg", delete=False) as f:
            ...
            found_colors = sum(1 for color in color_indicators if color in animation_content)
    ...
    def test_animation_timing_sequence(self, generator):
        ...
        with tempfile.NamedTemporaryFile(mode="w", suffix=".svg", delete=False) as f:
            ...
            assert len(unique_times) >= 2  # Should have at least 2 different timing values
