...
min_animation_duration = 10.0
    ...
    def test_generate_basic_gcode(self):
        ...
        try:
            ...
            assert "M104 S200" in content or "M109 S200" in content  # Nozzle temperature
    ...
    def test_generate_light_welds(self):
        ...
        try:
            ...
            assert "M104 S180" in content or "M109 S180" in content  # Light weld temperature
    ...
    def test_generate_mixed_weld_types(self):
        ...
        try:
            ...
            assert "M104 S200" in content or "M109 S200" in content  # Normal temperature
