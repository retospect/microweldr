...
class ValidationReport:
    ...
    def add_check(self, name: str, is_valid: bool, message: str = "", warnings: List[str] = None, errors: List[str] = None):
...
class ValidationSuite:
        ...
        with LogContext("svg_validation"):
            ...
            try:
                ...
                report.add_check(
                    ...
                    svg_result.is_valid,
                    svg_result.message,
                    warnings=svg_result.warnings if hasattr(svg_result, 'warnings') else [],
        ...
        with LogContext("gcode_validation"):
            ...
            if file_size == 0:
                ...
                report.add_check(
                    "file_size",
                    True,
                    f"G-code file size: {file_size / 1024:.1f}KB"
                )
            ...
            try:
                ...
                report.add_check(
                    ...
                    warnings=gcode_result.warnings if hasattr(gcode_result, 'warnings') else [],
    ...
    def validate_animation_file(self, animation_path: Union[str, Path]) -> ValidationReport:
        ...
        with LogContext("animation_validation"):
            ...
            report.add_check("file_exists", True, f"Animation file found: {animation_path}")
            ...
            try:
                ...
                report.add_check(
                    ...
                    warnings=animation_result.warnings if hasattr(animation_result, 'warnings') else [],
                    errors=[animation_result.message] if not animation_result.is_valid else []
                )
    ...
    def validate_secrets_file(self, secrets_path: Union[str, Path]) -> ValidationReport:
        ...
        with LogContext("secrets_validation"):
            ...
            # Security validation
            try:
                warnings, errors = self.secrets_validator.validate_secrets_file(str(secrets_path))
    ...
    def validate_configuration(self, config_path: Optional[Union[str, Path]] = None) -> ValidationReport:
        ...
        with LogContext("config_validation"):
            try:
                ...
                required_sections = ['printer', 'temperatures', 'normal_welds', 'movement']
                ...
                if missing_sections:
                    report.add_check(
                        ...
                        errors=[f"Missing configuration sections: {', '.join(missing_sections)}"]
                    )
                else:
                    report.add_check(
                        "config_structure",
